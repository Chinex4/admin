...
import EditKycModal from "../modals/EditKYCModal";
  ...
  return (
    <>
      <div className="mt-6 panel panel-pad">
        ...
        />
        <div className="relative table-wrap scrollbar-hide">
                  ...
                  <td className="px-3 py-2">
                    {kyc.frontImage ? (
                      <img
                        ...
                        onClick={() => {
                          setActiveImageUrl(kyc.frontImage);
                  ...
                  <td className="px-3 py-2">
                    {kyc.backImage ? (
                      <img
                        ...
                        className="w-16 h-16 object-cover rounded hover:opacity-90 transition duration-150 cursor-pointer"
                        onClick={() => {
                          setActiveImageUrl(kyc.backImage);
                          setShowImageModal(true);
                        }}
                      />
                    ) : (
                    ...
                    <Popover className="relative z-50">
                      <>
                        ...
                        >
                          <Popover.Panel
                            static
                            className="fixed top-[63%] left-[43%] lg:left-[87%] transform -translate-x-1/2 -translate-y-1/2 z-50 menu-panel"
                          >
                            {({ close }) => (
                              <>
                                ...
                                {directActions.map(({ label, action }, i) => (
                                  <button
                                    key={i}
                                    onClick={() => {
                                      action(label === "Edit KYC" ? kyc : kyc.id);
                                      close();
                                    }}
